                ...
                else
                {
                    if (y == 0)
                    {
                        ...
                        if (x == 1) { 
                            ...
                            color = char.IsUpper(symbol);  x++; break;}
                        if (x == 2) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 3) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 4) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 5) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 6) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 7) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 8) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 9) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 10) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 11) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 12) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 13) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 14) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 15) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 16) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 17) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 18) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 19) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 20) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 21) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 22) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 23) {  color = char.IsUpper(symbol);  x++; break; }
                        y++;
                    }
                    if (y == 1)
                    {
                        if (x == 0) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 1) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 2) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 3) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 4) {  color = char.IsUpper(symbol);  x++; break; }
                        if (x == 5) {  color = char.IsUpper(symbol);  x++; break; }
